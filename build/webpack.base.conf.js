...
function getEntry (rootSrc) {
  ...
  .forEach(file => {
    var key = relative('./src', file).replace('.js', '');
    map[key] = file;
  })
   return map;
}
...
const packagesPagesEntry = getEntry(resolve('./src/packages/**'), 'pages/**/main.js')
const entry = Object.assign({}, appEntry, pagesEntry,packagesPagesEntry)
